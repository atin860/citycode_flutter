...
class Couponpurchasedmodel {
  Couponpurchasedmodel({
      int? status, 
      dynamic error, 
      Messages? messages,}){
    _status = status;
  ...
  Couponpurchasedmodel.fromJson(dynamic json) {
    _status = json['status'];
    _error = json['error'];
  ...
  dynamic _error;
  Messages? _messages;
Couponpurchasedmodel copyWith({  int? status,
  dynamic error,
  Messages? messages,
}) => Couponpurchasedmodel(  status: status ?? _status,
  error: error ?? _error,
